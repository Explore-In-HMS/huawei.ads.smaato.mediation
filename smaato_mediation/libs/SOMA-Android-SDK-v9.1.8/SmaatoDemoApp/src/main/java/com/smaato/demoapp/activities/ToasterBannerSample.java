...
public class ToasterBannerSample extends AppCompatActivity implements AdListenerInterface, BannerStateListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		toaster = new ToasterBanner(this, rl);
	    toaster.addAdListener(this);
	    toaster.setBannerStateListener(this);
	    SharedPreferences prefs = ToasterBannerSample.this.getSharedPreferences(Constants.COM_SMAATO_DEMOAPP,

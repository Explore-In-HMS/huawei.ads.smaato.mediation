...
public class AppPhoneBannerSample extends AppCompatActivity implements OnClickListener,AdListenerInterface {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.app_phone_banner_sample);

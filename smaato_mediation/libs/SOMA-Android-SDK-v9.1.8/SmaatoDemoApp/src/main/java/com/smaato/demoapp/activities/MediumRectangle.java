...
public class MediumRectangle extends AppCompatActivity implements OnClickListener,AdListenerInterface {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBannerView.addAdListener(MediumRectangle.this);
		mBannerView.getAdSettings().setAdDimension(AdDimension.MEDIUMRECTANGLE);
		loadBanner = (Button) findViewById(R.id.load_ad );
		loadBanner.setOnClickListener(MediumRectangle.this);
		SharedPreferences prefs = MediumRectangle.this.getSharedPreferences(Constants.COM_SMAATO_DEMOAPP,

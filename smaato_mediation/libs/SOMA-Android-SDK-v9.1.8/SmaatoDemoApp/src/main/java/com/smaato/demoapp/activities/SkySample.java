...
public class SkySample extends AppCompatActivity implements OnClickListener,AdListenerInterface {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sky_sample);
		...
		mBannerView.addAdListener(SkySample.this);

		// skyscraper 120 by 600   , Leaderboard  728 by 90  // large 216*36


		mBannerView.getAdSettings().setAdDimension(AdDimension.SKYSCRAPER);
		SharedPreferences prefs = SkySample.this.getSharedPreferences(Constants.COM_SMAATO_DEMOAPP,

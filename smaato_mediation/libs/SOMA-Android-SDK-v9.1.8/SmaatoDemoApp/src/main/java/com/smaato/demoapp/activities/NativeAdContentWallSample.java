...
public class NativeAdContentWallSample extends Activity implements OnClickListener,
		AdListenerInterface {
	NativeAd nativeAd;
	...
	static String TAG = "NativeAdContentWallSample";

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_native_ad_content_wall_sample);
		reloadBanner = (Button) findViewById(R.id.load_ad );
		reloadBanner.setOnClickListener(NativeAdContentWallSample.this);
		nativeAd = new NativeAd(this);
		nativeAd.setAdListener(NativeAdContentWallSample.this);
		nativeRelativeLayout = (RelativeLayout) findViewById(R.id.nativeAdLayout);

		SharedPreferences prefs = NativeAdContentWallSample.this.getSharedPreferences(Constants.COM_SMAATO_DEMOAPP,
		...
		nativeAd2.setAdListener(NativeAdContentWallSample.this);
